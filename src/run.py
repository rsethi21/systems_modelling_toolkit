...
if __name__ == "__main__":
    ...
    rates = parse_rates("/home/rsethi/school_rsh/PKH/systems_modelling_toolkit/data/pi3k_pten_original/rates_fitted.csv")
    ...
    n.graph(y, time, substrates_to_plot=["pAKT", "pPTEN", "GSK3B", "LPS"], ylim_lower=0, ylim_higher=2)
