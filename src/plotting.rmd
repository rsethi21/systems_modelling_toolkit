...
```{r include=FALSE}
data.path.raw = "//wsl.localhost/Ubuntu-24.04/home/rsethi/school_rsh/PKH/systems_modelling_toolkit/data/pi3k_pten_totals/current_fit_raw.csv"
data.path.li = "//wsl.localhost/Ubuntu-24.04/home/rsethi/school_rsh/PKH/systems_modelling_toolkit/data/pi3k_pten_totals/current_fit_li.csv"
